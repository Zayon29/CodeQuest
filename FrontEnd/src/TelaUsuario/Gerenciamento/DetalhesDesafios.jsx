// src/components/Gerenciamento/DetalhesDesafios.jsx
      ...
      <div className="detail-body">
        <div className="detail-field-full">
          ...
          {isEditing ? (
            ...
            <span className="field-value">{desafio.titulo}</span>
          )}
        </div>
        ...
        <div className="detail-field-full">
          ...
          {isEditing ? (
            <textarea name="descricao" rows="4" value={formData.descricao} onChange={handleInputChange}></textarea>
          ) : (
            <p className="field-value-multiline">{desafio.descricao}</p>
          )}
        </div>
        ...
        <div className="detail-field-full">
          ...
          {isEditing ? (
            <textarea name="entradaExemplo" rows="2" value={formData.entradaExemplo} onChange={handleInputChange}></textarea>
          ) : (
            <pre className="field-value-code">{desafio.entradaExemplo}</pre>
          )}
        </div>
        ...
        <div className="detail-field-full">
          ...
          {isEditing ? (
            <textarea name="saidaExemplo" rows="2" value={formData.saidaExemplo} onChange={handleInputChange}></textarea>
          ) : (
            <pre className="field-value-code">{desafio.saidaExemplo}</pre>
          )}
        </div>
        ...
        <div className="detail-field-full">
          ...
          {isEditing ? (
            ...
            <span className="field-value">{desafio.linguagensSuportadas.join(', ')}</span>
          )}
        </div>
      </div>
